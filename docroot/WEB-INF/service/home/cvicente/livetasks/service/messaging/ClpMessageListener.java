...
package home.cvicente.livetasks.service.messaging;
...
import home.cvicente.livetasks.service.TaskServiceUtil;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			TaskTypeLocalServiceUtil.clearService();

			TaskTypeServiceUtil.clearService();
		}
	}
}