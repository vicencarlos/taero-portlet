...
import home.cvicente.livetasks.service.TaskTypeService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link home.cvicente.livetasks.service.impl.TaskTypeServiceImpl}.
 * </p>
 *
 * @author cvicente
 ...
 * @generated
 */
public abstract class TaskTypeServiceBaseImpl extends BaseServiceImpl
	implements TaskTypeService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link home.cvicente.livetasks.service.TaskTypeServiceUtil} to access the task type remote service.
	 */
	...
	private TaskTypeServiceClpInvoker _clpInvoker = new TaskTypeServiceClpInvoker();
}